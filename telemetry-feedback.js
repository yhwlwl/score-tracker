(() => {
  ...
  const APP_VERSION = 'score-tracker-v3-feedback';
  ...
  async function openThread(id, parent) {
    ...
    try {
      ...
      const atts = d.attachments || [], rootImgs = atts.filter(a => !a.reply_id), msgs = [{ author_type: 'user', content: d.feedback.content, created_at: d.feedback.created_at, id: null }, ...(d.replies || [])];
